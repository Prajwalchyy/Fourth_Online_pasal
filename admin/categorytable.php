...
<!-- main body section -->
    <div class="main-content">
        ...
        <h3 class="main-title">Category List</h3>
        <a href="addcategory.php" class="add-admin-btn">Add Category</a>
        <div class="table-container">

        <?php
          $i = 1;
          $rows = mysqli_query($conn, "SELECT * FROM category");
        ...
        <tr>
          ...
          endforeach; 
            ...
            echo"<div class='empty_text'>No Category Available</div>";
          }
          ?>
            </table>
        </div>
